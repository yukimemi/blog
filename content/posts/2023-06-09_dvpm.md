...
date: 2023-06-09
draft: false
description: "Vim/Neovimの設定ファイル自体をTypeScript (denops.vim) で記述し、プラグイン管理もDenoで行うためのライブラリ「dvpm」を作成しました。起動速度の改善などに効果があります。"
taxonomies:
...
この記事は [Zenn](https://zenn.dev/yukimemi/articles/2023-06-09-dvpm) にも投稿しています。
...
![neovim-startuptime](/static/images/neovim-startuptime.png)
...
![neovim-startuptime](/static/images/weather-buffer.png)
...
![weather-notify](/static/images/weather-notify.gif)
